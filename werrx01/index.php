...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-217279329-10"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-217279329-10');
</script>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body id="mycanvas" class="map" onbeforeunload="return myFunction()" style="cursor:none;" onclick="play()">
...
<div id="poptxt" class="lightbox">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: <script>document.write(phone)</script> (Toll-Free)</span>
    </div>
    <div id="bottom">
...
<audio id="audio" src="speech.mp3" loop></audio>	
